...
export const favicon="https://a.mktgcdn.com/p-sandbox/LYKn5KdDA5fEMOMXnWBGTKfPIpu8iA6niQbQVh60GFw/600x309.jpg";
export const apiKey = "9e1dfb4aa684bf6a159ccb10100acfcc";
...
export const center_latitude=36.174465;
export const center_longitude=-86.767960;
...
<path d="M877,4760h5a1,1,0,0,0,1-1v-8.59l.293.3a1,1,0,1,0,1.414-1.42l-9-9a1,1,0,0,0-1.414,0l-9,9a1,1,0,0,0,1.414,1.42l.293-.3V4759a1,1,0,0,0,1,1h5a1,1,0,0,0,1-1v-5h2v5A1,1,0,0,0,877,4760Zm4-2h-3v-5a1,1,0,0,0-1-1h-4a1,1,0,0,0-1,1v5h-3v-9.59l6-6,6,6Z" transform="translate(-865 -4739.998)" fill="#0078b4" fill-rule="evenodd"/>
</svg>`;
